...
<body>
	...
	<script type="text/javascript" charset="utf-8"
		src="plugins/ueditor1_2_6_1-src/ueditor.config.js"></script>
	<script type="text/javascript" charset="utf-8"
		src="plugins/ueditor1_2_6_1-src/_examples/editor_api.js"></script>


	<script type="text/javascript" charset="utf-8"
		src="statics/js/jquery-1.4.2.js"></script>
